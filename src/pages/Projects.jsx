      ...
      <BlueprintBackground />
            ...
            <div className="container-custom relative z-10">
                ...
                <header className="text-center mb-20 animate-fadeIn">
                    <h1 className="text-6xl md:text-7xl font-black tracking-tighter bg-gradient-to-b from-white to-white bg-clip-text text-transparent animate-maskReveal leading-[0.9] mt-15 ">
              Our <span className="gradient-text">Recent Works</span>
            </h1>
                    <p className="text-muted ">A showcase of innovative websites and digital solutions we've developed for our clients.</p>
                </header>
                ...
                <section className="py-20">
                         <div className="container-custom text-center">
                           ...
                           <div className="max-w-3xl mx-auto space-y-10">
                             ...
                             <h2 className="text-5xl font-bold">Inspired by our projects?</h2>
